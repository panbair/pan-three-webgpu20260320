...
.game-2d {
  ...
  height: 100%;
  overflow: hidden;
  background: url('/game/game-2d-2.png') no-repeat;
...
.game-overlay {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(135deg, rgba(15, 23, 42, 0.2) 0%, rgba(30, 41, 59, 0.3) 100%);
  display: flex;
  align-items: center;
  justify-content: center;
  z-index: 300;
